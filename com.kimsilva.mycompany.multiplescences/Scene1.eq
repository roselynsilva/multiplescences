...
public class Scene1 : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("pic1", "pic1", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial  color=#000000", 60);
			
			main1 = add_sprite_for_image(SEImage.for_resource("home1"));
		    sprite = add_sprite_for_image(SEImage.for_resource("pic1"));
			text = add_sprite_for_text("SCENE 1", "myfont");

			main1.move(0,600);
		    sprite.move(get_scene_width()*0.5,0);
			text.move(get_scene_width()*0.5,0);
	}
